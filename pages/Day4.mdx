...
export default function Page() {
  return (
    <>
      <div class="fixed mt-0 left-0 w-full h-12 flex flex-row items-center justify-center px-6 py-5 bg-blue-600 z-50">
  <span class="text-white text-base font-normal leading-none text-center">
    LAST CHANCE: Save 50% on all my Flutter books and bundles!
  </span>
</div>
      <div class="w-full bg-[#f6f6f6] p-5 mt-5 rounded-lg">
        <div class="flex flex-row items-start justify-start grow self-stretch p-5">
          <div class="self-stretch grow-0 flex flex-col justify-start items-stretch p-3">
            <div class= "w-[100%] bg-[#f6f6f6] p-5 rounded-lg">
              ...
              <code style={{ color: 'red' }}>cd <span style={{ color: '#5f5f5f' }}>hello_flutter </span></code>
                ...
                <div class=" self-stretch grow-0 flex flex-col justify-start items-stretch gap-6 pt-8 pr-16 pl-16 rounded-xl bg-[#f1f2f6]">
<div class=" self-stretch grow-0 flex flex-col justify-start items-center gap-4 p-0 ">
<div class=" w-[32px] h-[32px] grow-0 flex flex-col justify-center items-center gap-[10px] p-2 rounded-[99px] bg-[#1774ff]">
...
<span class="self-stretch grow-0 font-[roboto] text-xl font-medium non-italic text-center text-[#2d2d2d] ">
  It’s time to take a quiz! </span>
<span class ="self-stretch grow-0 text-sm font-medium non-italic text-center text-[#2d2d2d]">
 Test your knowledge and see what you’ve just learned.</span>
</div>
<div class="self-stretch grow-0 flex-col justify-start items-end p-6 rounded-lg border border-solid border-[#eee] bg-[#fff]">
<span class= "self-stretch grow-0 text-base font-medium non-italic text-center text-[#171717]">
 Search for ‘clsx’ in your code editor, what components use it to conditionally apply class names?</span>
<div class="self-stretch grow-0 flex flex-row justify-start items-center gap-4 pt-3 pr-4 pl-4 pb-3 border border-solid border-[#eee]">
<span class="w-[32px] h-[32px] grow-0 flex flex-col justify-center items-center gap-[10px] pt-8px pl-16px pr-16px rounded-[99px] border border-solid border-[#DDDDDD] bg-[#eaeefa]">
...
<span class="grow-0 font-[roboto] text-base font-medium non-italic text-center text-[#5f5f5f]">
‘status.tsx’ and ‘pagination.tsx’</span>
</div>
<div class="self-stretch grow-0 flex flex-row justify-start items-center gap-4 pt-[12px] pb-[12px] pl-[16px] pr-[16px] border border-solid border-[#eee]">
<span class="w-[32px] h-[32px] grow-0 flex flex-col justify-center items-center gap-[10px] pt-8px pl-16px pr-16px rounded-[99px] border border-solid border-[#DDDDDD] bg-[#eaeefa]">
...
<span class="grow-0 font-[roboto] text-base font-medium non-italic text-center text-[#5f5f5f]">
‘table.tsx’ and ‘status.tsx’</span>
</div>
<div class="self-stretch grow-0 flex flex-row justify-start items-center pt-[12px] pb-[12px] pl-[16px] pr-[16px] gap-4 border border-solid border-[#eee]">
<span class="w-[32px] h-[32px] grow-0 flex flex-col justify-center items-center gap-[10px] pt-8px pl-16px pr-16px rounded-[99px] border border-solid border-[#DDDDDD] bg-[#eaeefa]">
...
<span class="grow-0 font-[roboto] text-base font-medium non-italic text-center text-[#5f5f5f]">
‘nav-links.tsx’ and ‘table.tsx’</span>
</div>
</div>
</div>
          </div>
