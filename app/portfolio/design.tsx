const DesignPage = () => {
  return (
    <>
      ...
      <h3 className="  px-20 text-5xl w-945px h-54px pb-4  font-roboto pr-415 pt-32 text-48px font-medium tracking-0.4px text-[#171717] text-left align-middle leading-1.13 flex-grow-0">
        {" "}
        A{" "}
      ...
      <p className=" px-20  pt-1280 h-120px text-left self-stretch flex-grow-0 opacity-85 text-xl font-roboto font-normal not-italic leading-6 tracking-normal text-[#5f5f5f] ">
        {" "}
     ...
     <div className="  h-[138px] flex flex-col justify-start items-start gap-[16px] px-20"> 
     <span className="h-[74px] flex-grow-0 font-roboto text-[64px] font-semibold leading-[1.16] text-[#171717]"> Choose a plan that suits you</span>
     <span className="h-12 w-[640px] flex-grow-0 opacity-70 font-roboto text-base font-normal non-italic leading-6 tracking-widest text-left"> Both a free trial and a free set of features for anyone who wants to use them. The more orders your company
</span>
