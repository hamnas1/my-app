...
<div className=" flex flex-row  items-center gap-28">
    ...
    <button className=" flex flex-row justify-center items-center gap-10 rounded-lg p-2.5 bg-blue-500" > <span className=" font-roboto text-xs font-medium leading-5 text-left text-white"> Join The Challenge</span>
    </button>
</div>
        </div>
        <div className="grid grid-cols-2">
            <span className=" row-span-2 px-[80px] font-roboto text-[72px] font-semibold leading-normal text-left text-gray-800">
        Where the world learns Flutter?</span>
    
        
        
                    <div className="pt-[256px] grid grid-cols-2 ">
                        
                        <HeaderSubHeading>
                    <span >With more free Flutter tutorials than any other site <span className=" text-blue-600">100 Days of Flutter challenge</span>
                    will help you learn app development.Join our free community-driven challenge to become a proficient Flutter developer.</span>
...
<div className="px-[0px] circlePosition w-[300px] h-[271.1px] bg-[#2279fc] absolute z-1 right-[60%]  taranslate-x-[50%] translate-y-[100%] filter blur-[600px]  ">
      ...
      <div className=" flex flex-col justify-start items-center gap-[64px] my-[72px] mx-[80px] pt-0 pb-[120px] px-0">
      <Image
...
From Beginner to Pro in 100 Days. Learning through action and community building.
</span>
 </div>
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#1774FF" className="size-6">
