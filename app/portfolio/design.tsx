const DesignPage = () => {
  return (
    ...
    <div className=" w-26 h-8 flex flex-row justify-start items-center gap-2 p-2">
        <span className="w-8 h-4 font-[roboto] text-xs font-medium leading-4 tracking-wide text-center text-gray-700"> FREE</span>
    </div>
...
<button className="h-12 w-full flex flex-row justify-center items-center gap-2 p-3 rounded-lg bg-blue-100">
    <span className="w-30 h-6 font-[roboto] text-base font-medium leading-6 text-center text-blue-500"> Get Started Now</span>
</button>
    </div>
